"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[7777],{10376:function(e,t,r){r.d(t,{p:function(){return rl}});var i,n=r(93304),s=r(84534),a=r(18650),o=r(53576);function c(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}let l=new s.LL("auth","Firebase",c()),h=new a.Yd("@firebase/auth");function u(e,...t){h.logLevel<=a.in.ERROR&&h.error(`Auth (${n.Jn}): ${e}`,...t)}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class e4 extends s.ZR{constructor(e,t,r,i){super(t.code,t.message),this.operationType=r,this.user=i,Object.setPrototypeOf(this,e4.prototype),this.customData={appName:e.name,tenantId:e.tenantId??void 0,_serverResponse:t.customData._serverResponse,operationType:r}}static _fromErrorAndOperation(e,t,r,i){return new e4(e,t,r,i)}}function e5(e,t,r,i){return("reauthenticate"===t?r._getReauthenticationResolver(e):r._getIdTokenResponse(e)).catch(r=>{if("auth/multi-factor-auth-required"===r.code)throw e4._fromErrorAndOperation(e,r,t,i);throw r})}async function e6(e,t,r=!1){let i=await $(e,t._linkToIdToken(e.auth,await e.getIdToken()),r);return e3._forOperation(e,"link",i)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function e8(e,t,r=!1){if((0,n.rh)(e.app))return Promise.reject(m(e));let i="signIn",s=await e5(e,i,t),a=await e3._fromIdTokenResponse(e,i,s);return r||await e._updateCurrentUser(a.user),a}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
