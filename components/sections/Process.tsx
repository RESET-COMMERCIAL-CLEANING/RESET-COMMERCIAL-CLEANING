...
export function Process() {
  return (
    <section id="process" className="relative w-full bg-black py-20 md:py-32">
              ...
              return (
                <motion.div key={index} variants={itemVariants} className="relative">
                  <div className={`flex gap-8 items-center ${isEven ? 'lg:flex-row' : 'lg:flex-row-reverse'}`}>
                    ...
                    {/* Image */}
                    <div className="flex-1">
                      <div className="relative w-full h-80 md:h-96 rounded-xl overflow-hidden glass hover:glass-dark transition-all duration-300 flex items-center justify-center">
                        <img
                          src={step.image}
                          alt={step.title}
