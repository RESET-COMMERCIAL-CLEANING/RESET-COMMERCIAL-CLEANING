        ...
        <div className="container">
          ...
          >
            <h1 className="text-6xl md:text-7xl font-bold mb-6">
              <span className="block text-white">The RESET</span>
                ...
                >
                  ...
                  <div className="flex-1">
                    <motion.div
                      ...
                      className="w-full h-64 rounded-xl bg-gradient-to-br from-reset-green/20 to-reset-green/5 flex items-center justify-center overflow-hidden"
                    >
                      <Icon className="w-32 h-32 text-reset-green/40" />
                    </motion.div>
                  </div>
      ...
      <section className="w-full py-20">
        <div className="container text-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-5xl md:text-6xl font-bold mb-6">Ready to Reset?</h2>
            <p className="text-xl text-gray-400 mb-8 max-w-2xl mx-auto">
              Start your reset journey today with a free assessment.
            </p>
